...
const feature = () => {
  return (
      ...
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-2xl mx-auto text-center pb-10">
          ...
          <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">
            ...
            numquam beatae exercitationem inventore praesentium rem culpa
            aliquam et veritatis assumenda!
          </p>
        </div>
        <div class="space-y-12 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className="flex justify-center items-center flex-col bg-white p-6 rounded text-center">
    ...
    <section className="bg-slate-50 text-black py-12">
      <div className="container mx-auto text-center">
        <h2 className="text-5xl font-bold mb-4">Hydra Tokenomics</h2>
        <p className="text-gray-600 mb-12">This section states Hydra tokenomics and all the information related to the token presale</p>
        <div className="space-y-12 text-center">
          <div className="flex flex-col md:flex-row-reverse items-center text-center">
            ...
            <div className="md:w-1/2 p-4 text-left">
              <h3 className="text-2xl font-bold"> Hydra Token Distribution</h3>
