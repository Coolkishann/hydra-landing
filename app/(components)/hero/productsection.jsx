  ...
  return (
    <section className="bg-gray-100 text-black py-12">
      <div className="container mx-auto text-center">
        <h2 className="text-6xl font-bold mb-4">Preview of the products</h2>
        ...
        <div className="mt-24">
          <div className="flex flex-col md:flex-row items-center mb-10">
            ...
            <div className="md:w-1/3 p-4 mt-4  mx-auto">
              <h3 className="text-4xl mb-8 font-bold">Freedom Phone</h3>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center mb-10">
            ...
            <div className="md:w-1/3 p-4 mt-4  mx-auto">
              <h3 className="text-4xl mb-8 font-bold">First quantum-resistant hardware wallet card</h3>
          ...
          <div className="flex flex-col md:flex-row items-center mb-10">
            ...
            <div className="md:w-1/3 p-4 mt-4  mx-auto">
              <h3 className="text-4xl mb-8 font-bold">Quantum-resistant decentralized cloud storage solution</h3>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center mb-10">
            ...
            <div className="md:w-1/3 p-4 mt-4  mx-auto">
              <h3 className="text-4xl mb-8 font-bold">Radio Meshnet</h3>
          ...
          <div className="flex flex-col md:flex-row items-center mb-10">
            ...
            <div className="md:w-1/3 p-4 mt-4  mx-auto">
              <h3 className="text-4xl mb-6 font-bold">Dualband radio module for Freedom Phone</h3>
